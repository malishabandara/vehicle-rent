...
const seoData = {
  ...
  '/fleet': {
    title: 'Vehicle Fleet - Car Rental Sri Lanka | CNS Travels | Nano, Mini, Van, Bus, Lorry Hire',
    description: 'Explore our comprehensive vehicle fleet for car rental Sri Lanka. Choose from Nano cars, Mini cars, Wagon R, Sedan cars, Luxury cars, Mini vans, AC vans, KDH vans, buses, AC buses, and lorries. Professional drivers included.',
  ...
  '/about': {
    title: 'About CNS Travels - Sri Lanka\'s Premier Vehicle Hire Service | Car Rental Sri Lanka',
    description: 'Learn about CNS Travels, Sri Lanka\'s leading vehicle hire service. Professional car rental, van hire, bus hire and lorry hire with experienced drivers across Sri Lanka.',
  ...
  '/contact': {
    title: 'Contact CNS Travels - Book Your Car Rental Sri Lanka | Get Instant Quote',
    description: 'Contact CNS Travels for car rental Sri Lanka bookings. Get instant quotes for vehicle hire services. Professional drivers, 24/7 service, islandwide coverage.',
